...
> **Profil en vigueur : AXENTIA HER 2027 (PMT2026)**, relevé sur LEON 2026-043h (SIMTEST_BM_HAB) le 10/08/2026. Il *est* le référentiel du dépôt et a remplacé AXENTIA HER 2026. Changement majeur : le Livret A de référence (`ParaGEN!DD20`) passe de 2,40 % à 1,50 %, donc tous les prêts CDC démarrent sur ce taux. Les chiffres cités dans la liste ci-dessous sont ceux du profil précédent, gardés pour mémoire ; les valeurs en vigueur sont dans les fichiers.
