...
- **R-SUB-3** ✅ Gratuité et affectation : chaque subvention porte flag gratuit (1/0) et affectation PLUS/PLAI/PLUS-PLAI (ventilée par qpSU). Agrégats gratuites/non gratuites → équilibre. Source calculs!D295:D314. **Affectation multi-produits réellement implémentée le 03/09/2026** : jusque-là, toute affectation qui n'était pas *exactement* un code de tranche était ignorée en silence et la subvention se ventilait sur l'opération entière. Sur une opération PLAI + PLUS + LIBRE, 90 000 € affectés « PLUS-PLAI » partaient en trois parts de 30 000, dont une finançait du logement libre. `resoudreAffectation` accepte désormais les séparateurs `-`, `+`, `,` et l'espace, ne retient que les tranches **présentes au programme**, et renormalise leurs quotes-parts SU entre elles. Une affectation qui ne désigne aucune tranche présente vaut absence d'affectation, comme avant. Enfin, une subvention qui ventile sur une tranche `eligible_aides_publiques: false` (le libre) n'est pas corrigée d'office - le montant saisi fait foi, une participation de collectivité de droit commun existe - mais elle **est signalée**.
