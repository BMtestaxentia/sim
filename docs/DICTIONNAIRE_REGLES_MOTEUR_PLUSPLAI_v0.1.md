...
- **R-LOYER-9** ✅ Millésime du barème de loyers (07/08/2026). Les plafonds sont revalorisés au 1er janvier : le barème porte donc une `annee_reference`, saisissable. Elle appartient au BARÈME et non à la simulation - la faire suivre l'année de livraison ferait passer les valeurs 2025 pour celles de 2029. L'écart se rattrape par l'option `options.revaloriser_loyers_plafonds`, qui indexe le plafond de zone (et lui seul : la marge locale est une saisie en euros du jour) sur le cumul des IRL de la trajectoire entre le millésime et la mise en location. **Inactive par défaut** : aucune source ne dit que LEON revalorise, et l'imposer déplacerait les golden tests, donc le contrat de reproduction. Dans les deux cas le moteur alerte - inactive, il chiffre ce que l'écart coûte (années, pourcentage, euros de loyers annuels) ; active, il nomme l'écart assumé avec LEON. Reste ouvert : LEON revalorise-t-il ?
