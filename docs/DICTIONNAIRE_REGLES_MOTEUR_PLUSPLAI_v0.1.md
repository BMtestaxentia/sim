...
- **R-SUB-3** ✅ Gratuité et affectation : chaque subvention porte un flag gratuit (1/0) et une affectation qui nomme **une tranche, et une seule**. Agrégats gratuites/non gratuites → équilibre. Source calculs!D295:D314. **Pas de couple PLUS-PLAI** (arbitrage métier du 03/09/2026) : LEON connaît une affectation composite « PLUS-PLAI » ventilée au prorata SU entre ses deux colonnes, conséquence de son moteur dupliqué. Ici le PLUS et le PLAI sont deux tranches **totalement distinctes**, et une aide qui vise les deux se saisit en deux lignes. Écart E-13. Trois issues : la tranche nommée existe au programme et prend tout ; aucune affectation, et la subvention profite à l'opération au prorata SU ; une affectation nommée mais **introuvable** au programme (dont le code composite de LEON), ventilée comme une subvention non affectée **et signalée par une alerte**. C'est ce dernier cas qui passait en silence avant l'audit du 03/09/2026 : une affectation inconnue était ignorée sans un mot, et la subvention finançait au passage la tranche libre. Enfin, une subvention qui ventile sur une tranche `eligible_aides_publiques: false` (le libre) n'est pas corrigée d'office - le montant saisi fait foi, une participation de collectivité de droit commun existe - mais elle **est signalée**.
